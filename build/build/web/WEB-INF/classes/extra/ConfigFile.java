...
public class ConfigFile {
 public boolean createConfig(String ws,String filename) throws IOException{
        String conf="-t:dll\n"
                ...
                + "flag:lib=/root/Temp/ODIN/verilog-20040606/tgt-odin/tech_lib.xml\n"
                + "flag:dynamic_debug_file=/root/Temp/ODIN/verilog-20040606/tgt-odin/dynamic_debug_file.xml\n"
                + "flag:optimization_file=/root/Temp/ODIN/verilog-20040606/tgt-odin/optimization_file.xml\n"
                + "out:/root/Temp/"+ws+"/"+filename+".synthesized.v";
        Writer output = null;
        try{
        File file = new File("/root/Temp/"+ws+"/config_file.txt");
...
//    /root/Temp/ODIN/verilog-20040606/./ivl -C /root/Temp/4/config_file.txt /root/Temp/4/hello.vl
    ...
    compile[0]="/root/Temp/ODIN/verilog-20040606/./ivl";
    compile[1]="-C";
    compile[2]="/root/Temp/"+ws+"/config_file.txt";
    compile[3]="/root/Temp/"+ws+"/"+filename+".vl";
